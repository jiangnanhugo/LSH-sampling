...
def hyperplane_lsh(Q, K, V, attention, L, dk):
    """
    Our implemented LSH attention. It requires an extra step to check every bucket has qi vectors.
    :param Q:
    :param K:
    :param V:
    :param attention:
    ...
    for i in range(n_buckets):
        ...
        # we combine the exponential operation into the vector product steps
        # also we choose the relevant vi vectors and directly multiple with the softmax output.
        # we fuse these operators and do not call them step by step.
